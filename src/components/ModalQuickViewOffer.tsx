...
import ProductChartOffer from "./ProductChartOffer";
import { usePathname } from "next/navigation";

export interface ModalQuickViewOfferProps {
  show: boolean;
  onCloseModalQuickView: () => void;
}

const ModalQuickViewOffer: FC<ModalQuickViewOfferProps> = ({
  show,
...
export default ModalQuickViewOffer;
